# Autor: Jorge Marqués 
# Fecha: 2024-07-22
# Review: Angel Rodriguez (From Export Folders to Plot)
...
start_date_str = "2025-09-29 15:00:00"
try:
...
engine = create_engine('postgresql+psycopg2://iaxo:bujaruelo@127.0.0.1:5432/alphacammdb')
